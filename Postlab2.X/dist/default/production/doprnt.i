...
# 416 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
static double
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 628 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 644 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
   {
    prec = 0;
  ...
  case 0:
   goto alldone;
# 688 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
...
# 1138 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
     if(prec <= 12)
    ...
    for(c = 1 ; c != (sizeof dpowers/sizeof dpowers[0]) ; c++)
     if(val < dpowers[c])
      break;
# 1201 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
    {
# 1214 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
    if(flag & 0x03)
...
# 1316 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
# 1331 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1365 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  if(c < prec)
   c = (char)prec;
  else if(prec < c)
   prec = c;
